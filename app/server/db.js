...
// Migrate: add foto column to existing patients tables
...
const insertTpl = db.prepare('INSERT OR IGNORE INTO templates (id, name, valor, obs) VALUES (?, ?, ?, ?)');
defaultTemplates.forEach(t => insertTpl.run(...t));

module.exports = { db, hashPw };
