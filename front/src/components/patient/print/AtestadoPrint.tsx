...
const AtestadoPrint = forwardRef<HTMLDivElement, AtestadoPrintProps>(function AtestadoPrint({ patient, clinic, days, reason }, ref) {
  ...
  const numberOfDays = parseInt(String(days), 10) || 0
